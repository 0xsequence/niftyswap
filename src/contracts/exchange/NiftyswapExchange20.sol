...
contract NiftyswapExchange20 is ReentrancyGuard, ERC1155MintBurn, INiftyswapExchange20 {
  ...
  {
    require(_deadline >= block.timestamp, "NiftyswapExchange#buyTokens: DEADLINE_EXCEEDED");
    require(_tokenIds.length > 0, "NiftyswapExchange#buyTokens: INVALID_CURRENCY_IDS_AMOUNT");
