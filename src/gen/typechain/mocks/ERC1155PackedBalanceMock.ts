...
export interface ERC1155PackedBalanceMockInterface extends utils.Interface {
  functions: {
...
export interface ERC1155PackedBalanceMock extends BaseContract {
  ...
  functions: {
    ...
    getValueInBin(
      _binValues: PromiseOrValue<BigNumberish>,
