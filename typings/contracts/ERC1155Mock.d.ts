...
export class ERC1155Mock extends Contract {
  connect(signerOrProvider: Signer | Provider | string): ERC1155Mock;
  attach(addressOrName: string): ERC1155Mock;
  deployed(): Promise<ERC1155Mock>;

  on(event: EventFilter | string, listener: Listener): ERC1155Mock;
  once(event: EventFilter | string, listener: Listener): ERC1155Mock;
  addListener(eventName: EventFilter | string, listener: Listener): ERC1155Mock;
  removeAllListeners(eventName: EventFilter | string): ERC1155Mock;
  removeListener(eventName: any, listener: Listener): ERC1155Mock;
