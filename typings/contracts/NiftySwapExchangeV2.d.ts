...
interface NiftySwapExchangeV2Interface extends Interface {
  functions: {
...
export class NiftySwapExchangeV2 extends Contract {
  connect(signerOrProvider: Signer | Provider | string): NiftySwapExchangeV2;
  attach(addressOrName: string): NiftySwapExchangeV2;
  deployed(): Promise<NiftySwapExchangeV2>;

  on(event: EventFilter | string, listener: Listener): NiftySwapExchangeV2;
  once(event: EventFilter | string, listener: Listener): NiftySwapExchangeV2;
  addListener(
    eventName: EventFilter | string,
    listener: Listener
  ): NiftySwapExchangeV2;
  removeAllListeners(eventName: EventFilter | string): NiftySwapExchangeV2;
  removeListener(eventName: any, listener: Listener): NiftySwapExchangeV2;

  interface: NiftySwapExchangeV2Interface;
